...
// ═══ 📞 TELEFONIA — app/crm/telefonia/page.tsx (UnitaSystem) ═══
// AUTOCONTIDA: conexões VOIP embutidas na própria página (sem import de
// componente externo — não tem como quebrar build por module not found).
