...
export default function TelefoniaPage() {
  ...
  if (!carregado) {
    return (
      <div style={{ padding: 32, fontFamily: "Arial, sans-serif", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "60vh" }}>
        <div style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 14, boxShadow: "0 1px 3px rgba(0,0,0,0.06)", padding: "20px 28px", display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ width: 18, height: 18, borderRadius: "50%", border: "3px solid #e5e7eb", borderTopColor: "#16a34a", animation: "wolf-spin 0.8s linear infinite" }} />
  ...
  if (!isDono && !isSuperAdmin && !permissoes.voip_conexoes) {
    return (
      <div style={{ minHeight: "100vh", padding: 32, fontFamily: "Arial, sans-serif", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 14, boxShadow: "0 1px 3px rgba(0,0,0,0.06)", padding: 48, textAlign: "center", maxWidth: 480 }}>
          ...
          <p style={{ color: "#6b7280", fontSize: 13, margin: 0, lineHeight: 1.5 }}>
            Você não tem permissão para gerenciar conexões VOIP. Entre em contato com o administrador do sistema.
          </p>
        </div>
      </div>
    );
