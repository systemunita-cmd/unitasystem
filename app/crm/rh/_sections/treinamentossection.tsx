...
// 🧑‍💼 RH · Treinamentos (CONECTADO — 'treinamentos'; cargaHoraria↔carga_horaria)
const COR = "#4f46e5";
const card = {
  background: "#ffffff",
  borderRadius: 14,
...
export function TreinamentosSection() {
    ...
    if (error) {
      ...
      setLista(
        (data || []).map((r: any) => ({
          ...
          status: (r.status || "planejado") as StatusT,
          data: r.data || "",
        }))
      );
    setCarregando(false);
  ...
  const salvar = async () => {
    ...
    const payload = {
      ...
      carga_horaria: form.cargaHoraria || 0,
      status: form.status,
      data: form.data || null,
    };
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      {carregando ? (
        ...
        <div style={{ ...card, padding: 40, textAlign: "center" }}>
          ...
          <p style={{ color: "#6b7280", fontSize: 13 }}>Nenhum treinamento cadastrado.</p>
        </div>
      ) : (
        <div
          style={{
              ...
              >
                ...
                >
                  <span style={{ color: "#6b7280", fontSize: 12 }}>
                    👥 {t.participantes} · ⏱️ {t.cargaHoraria}h
                  </span>
                  <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                    <span style={{ color: "#4338ca", fontSize: 12, fontWeight: 700 }}>{dataBR(t.data)}</span>
                    <button
                      onClick={() => excluir(t)}
                      style={{
                        background: "#fef2f2",
      ...
      {modal && (
        ...
        >
          <div
            ...
            style={{ ...card, width: "100%", maxWidth: 540, overflow: "hidden" }}
          >
            <div
              style={{
                padding: "18px 24px",
            ...
            <div style={{ padding: 24, display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 14 }}>
                <Campo label="Participantes">
                  <input
                    ...
                    onChange={(e) => set("participantes", Number(e.target.value))}
                    style={inputStyle}
                  />
                </Campo>
                <Campo label="Carga (h)">
              ...
              <Campo label="Status">
                <select
                  value={form.status}
                  onChange={(e) => set("status", e.target.value as StatusT)}
                  style={inputStyle}
                >
