...
export function IntegracaoFinanceiraSection(){
 ...
 return <div style={{display:"grid",gap:16}}>
  <div><h1 style={{margin:0,fontSize:24}}>RH → Financeiro</h1><p style={{fontSize:12,color:"#64748b"}}>Folha integrada com salário, benefícios, ajudas de custo, encargos e comissões de vendas instaladas.</p></div>
