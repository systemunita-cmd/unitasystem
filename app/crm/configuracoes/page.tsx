...
const CATEGORIAS_PERMISSAO = [
  { nome: "🎯 CRM", cor: "#16a34a", permissoes: [
    ...
    { key: "vendas_fila", label: "Ver vendas da própria fila" },
    { key: "vendas_equipe", label: "Ver vendas do próprio PDV/equipe" },
  ...
  { nome: "🧑‍💼 RH", cor: "#4f46e5", permissoes: [
    ...
    { key: "rh_funcionarios_editar", label: "      ✏️ editar Funcionários" },
    { key: "rh_departamentos", label: "↳ Departamentos" },
    { key: "rh_departamentos_editar", label: "      ✏️ editar Departamentos" },
    { key: "rh_cargos", label: "↳ Cargos & Salários" },
    { key: "rh_cargos_editar", label: "      ✏️ editar Cargos & Salários" },
    // Folha de Pagamento
    { key: "rh_folha", label: "↳ Folha do Mês" },
    { key: "rh_folha_editar", label: "      ✏️ editar Folha do Mês" },
    { key: "rh_holerites", label: "↳ Holerites" },
    { key: "rh_holerites_editar", label: "      ✏️ editar Holerites" },
    { key: "rh_encargos", label: "↳ Encargos & Impostos" },
    { key: "rh_encargos_editar", label: "      ✏️ editar Encargos & Impostos" },
    // Jornada & Tempo
    { key: "rh_ponto", label: "↳ Ponto / Frequência (todos)" },
    { key: "rh_ponto_editar", label: "      ✏️ editar Ponto / Frequência" },
    { key: "rh_ponto_fila", label: "↳ Ponto / Frequência (só da própria fila)" },
    { key: "rh_ferias", label: "↳ Férias" },
    { key: "rh_ferias_editar", label: "      ✏️ editar Férias" },
    { key: "rh_afastamentos", label: "↳ Afastamentos" },
    { key: "rh_afastamentos_editar", label: "      ✏️ editar Afastamentos" },
    { key: "rh_banco_horas", label: "↳ Banco de Horas" },
    { key: "rh_banco_horas_editar", label: "      ✏️ editar Banco de Horas" },
    // Benefícios
    { key: "rh_beneficios", label: "↳ Benefícios" },
    { key: "rh_beneficios_editar", label: "      ✏️ editar Benefícios" },
    { key: "rh_vale_transporte", label: "↳ Vale Transporte" },
    { key: "rh_vale_transporte_editar", label: "      ✏️ editar Vale Transporte" },
    { key: "rh_vale_refeicao", label: "↳ Vale Refeição" },
    { key: "rh_vale_refeicao_editar", label: "      ✏️ editar Vale Refeição" },
    { key: "rh_plano_saude", label: "↳ Plano de Saúde" },
    { key: "rh_plano_saude_editar", label: "      ✏️ editar Plano de Saúde" },
    // Recrutamento
    { key: "rh_vagas", label: "↳ Vagas" },
    { key: "rh_vagas_editar", label: "      ✏️ editar Vagas" },
    { key: "rh_candidatos", label: "↳ Candidatos" },
    { key: "rh_candidatos_editar", label: "      ✏️ editar Candidatos" },
    { key: "rh_selecao", label: "↳ Processos Seletivos" },
    { key: "rh_selecao_editar", label: "      ✏️ editar Processos Seletivos" },
    // Desenvolvimento
    { key: "rh_treinamentos", label: "↳ Treinamentos" },
    { key: "rh_treinamentos_editar", label: "      ✏️ editar Treinamentos" },
    { key: "rh_avaliacoes", label: "↳ Avaliações de Desempenho" },
    { key: "rh_avaliacoes_editar", label: "      ✏️ editar Avaliações de Desempenho" },
    // Documentos
    { key: "rh_documentos", label: "↳ Documentos" },
    { key: "rh_documentos_editar", label: "      ✏️ editar Documentos" },
    { key: "rh_contratos", label: "↳ Contratos" },
    { key: "rh_contratos_editar", label: "      ✏️ editar Contratos" },
    // Config
    { key: "rh_config", label: "↳ Configurações do RH" },
    { key: "rh_config_editar", label: "      ✏️ editar Configurações do RH" },
  ]},
